...
export function StrokeText({
  ...
  useEffect(() => {
    ...
    const strokes = gsap.utils.toArray(root.querySelectorAll('[data-stroke-char]')) as SVGTextPathElement[]
    const fills = gsap.utils.toArray(root.querySelectorAll('[data-fill-char]')) as SVGTextPathElement[]
  ...
  return (
    <span
      ...
      style={{ ...style, '--stroke-text-height': `${Math.round(Number(fontSize) * 1.3)}px` } as CSSProperties}
      role="img"
